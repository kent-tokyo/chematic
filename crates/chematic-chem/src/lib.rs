...
pub use topo_descriptors::{
    ...
    labute_asa_per_atom, padmakar_ivan_index, petitjean_index, randic_index, schultz_mti,
    topological_distance_matrix, vabc, wiener_index, zagreb_index_m1, zagreb_index_m2,
};
