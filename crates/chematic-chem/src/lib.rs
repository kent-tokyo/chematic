...
pub use descriptors::{
    ...
    num_sulfurs, num_unspecified_stereocenters, pfizer_3_75_passes, rdkit_aromatic_ring_count,
    rdkit_hba_count, rdkit_molecular_weight, reos_passes, ring_bundle, ring_count,
    ring_system_count, ro3_passes, rotatable_bond_atom_pairs, rotatable_bond_count, tpsa,
