...
//! `docs/canonical-ez-plan.md`), and -- at least theoretically,
...
//! rate. See `docs/canonical-ez-plan.md` and this module's own
...
/// occur in practice (0/4,992 in the recorded 5,000-molecule corpus scan).
