...
**36805997+kent-tokyo@users.noreply.github.com**, or privately via
[GitHub Security Advisories](https://github.com/kent-tokyo/chematic/security/advisories)
for security-adjacent reports (see [SECURITY.md](SECURITY.md)). All complaints
