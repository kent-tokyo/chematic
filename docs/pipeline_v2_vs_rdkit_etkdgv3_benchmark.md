...
- `benchmark_session`: priority2b_mmff94_stbn_dfsb_fallback_227
- `benchmark_date`: 2026-08-06
- `benchmark_branch`: feat/mmff94-stbn-dfsb-fallback-227-priority2b
...
| chematic | chematic_pipeline_v2_mmff94_strict_stretch_bend_gated | 265 | 149 | 149 | 100.0% | 56.2% | 12 | 104 | 0 | 0 |
| chematic | chematic_pipeline_v2_mmff94_with_uff_fallback_stretch_bend_gated | 265 | 252 | 252 | 100.0% | 95.1% | 13 | 0 | 0 | 0 |
| chematic | chematic_pipeline_v2_mmff94_strict_complete_bonded_term_gated | 265 | 86 | 86 | 100.0% | 32.5% | 12 | 167 | 0 | 0 |
...
**mmff94_strict, spelled out per the fix request:** 149/149 successful outputs are independently sound, but only 149/265 of the *total corpus* ends up as a usable geometry under this arm -- the rest is the 116-molecule MMFF94 coverage gap (issue #227), governed by this arm's own bond+angle coverage gate (`mmff94_strict` never gated stretch-bend, even before Priority 2B, so porting the Dfsb fallback into production doesn't change which molecules pass this specific arm -- it changes their energy/geometry, not their success/failure here; stretch-bend coverage itself is now fully resolved in production, 0 missing instances measured this run, see the Bonded-term coverage gate section below), not a geometry-quality problem.
...
| chematic | chematic_pipeline_v2_mmff94_strict_stretch_bend_gated | 149 | 100.0% | 0.7% | 0.0% | 0 | 0 | 100.0% |
| chematic | chematic_pipeline_v2_mmff94_with_uff_fallback_stretch_bend_gated | 252 | 100.0% | 0.7% | 0.0% | 0 | 0 | 100.0% |
| chematic | chematic_pipeline_v2_mmff94_strict_complete_bonded_term_gated | 86 | 100.0% | 0.4% | 0.0% | 0 | 0 | 100.0% |
| chematic | chematic_pipeline_v2_mmff94_with_uff_fallback_complete_bonded_term_gated | 250 | 100.0% | 0.6% | 0.0% | 0 | 0 | 100.0% |
...
| chematic | chematic_pipeline_v2_mmff94_strict_stretch_bend_gated | 64 | 111 | 61 | 50 | 0 | 55.0% |
| chematic | chematic_pipeline_v2_mmff94_with_uff_fallback_stretch_bend_gated | 82 | 143 | 81 | 62 | 0 | 56.6% |
| chematic | chematic_pipeline_v2_mmff94_strict_complete_bonded_term_gated | 39 | 62 | 37 | 25 | 0 | 59.7% |
| chematic | chematic_pipeline_v2_mmff94_with_uff_fallback_complete_bonded_term_gated | 80 | 140 | 87 | 53 | 0 | 62.1% |
...
|---|---|---|---|---|---|
| chematic_pipeline_v2_no_ff | 265 | 4.0 | 30.8 | 40.0 | 74 |
| chematic_pipeline_v2_dreiding | 265 | 140.0 | 1365.0 | 1616.5 | 1716 |
| chematic_pipeline_v2_uff_only | 265 | 235.0 | 1736.6 | 2991.4 | 5262 |
| chematic_pipeline_v2_mmff94_strict | 265 | 27.0 | 7820.8 | 10675.2 | 16221 |
| chematic_pipeline_v2_mmff94_with_uff_fallback | 265 | 570.0 | 7553.2 | 10553.7 | 15110 |
| chematic_pipeline_v2_mmff94_strict_repair | 265 | 17.0 | 7777.2 | 10035.6 | 15741 |
| chematic_pipeline_v2_mmff94_with_uff_fallback_repair | 265 | 435.0 | 7757.6 | 10003.5 | 15371 |
| chematic_pipeline_v2_mmff94_strict_stretch_bend_gated | 265 | 27.0 | 7650.6 | 9705.2 | 15617 |
| chematic_pipeline_v2_mmff94_with_uff_fallback_stretch_bend_gated | 265 | 562.0 | 7548.2 | 9553.8 | 16262 |
| chematic_pipeline_v2_mmff94_strict_complete_bonded_term_gated | 265 | 11.0 | 1284.2 | 6115.7 | 15368 |
| chematic_pipeline_v2_mmff94_with_uff_fallback_complete_bonded_term_gated | 265 | 435.0 | 2295.4 | 6077.2 | 15065 |
| chematic_legacy_etkdg | 265 | 0.0 | 5.0 | 7.7 | 14 |
...
- chematic_pipeline_v2_mmff94_with_uff_fallback: n=252, fallback_rate=40.9%, converged_rate=17.9%
- chematic_pipeline_v2_mmff94_strict: n=149, fallback_rate=0.0%, converged_rate=25.5%
- chematic_pipeline_v2_mmff94_strict_repair: n=131, fallback_rate=0.0%, converged_rate=28.2%
- chematic_pipeline_v2_mmff94_with_uff_fallback_repair: n=229, fallback_rate=42.8%, converged_rate=18.8%
- chematic_pipeline_v2_mmff94_strict_stretch_bend_gated: n=149, fallback_rate=0.0%, converged_rate=25.5%
- chematic_pipeline_v2_mmff94_with_uff_fallback_stretch_bend_gated: n=252, fallback_rate=40.9%, converged_rate=17.9%
- chematic_pipeline_v2_mmff94_strict_complete_bonded_term_gated: n=86, fallback_rate=0.0%, converged_rate=43.0%
- chematic_pipeline_v2_mmff94_with_uff_fallback_complete_bonded_term_gated: n=250, fallback_rate=65.6%, converged_rate=17.6%
...
| chematic_pipeline_v2_mmff94_strict_stretch_bend_gated | 265 | 254 | 254 | 254 | 149 | 149 | 149 |
| chematic_pipeline_v2_mmff94_with_uff_fallback_stretch_bend_gated | 265 | 254 | 254 | 254 | 252 | 252 | 252 |
| chematic_pipeline_v2_mmff94_strict_complete_bonded_term_gated | 265 | 254 | 254 | 254 | 86 | 86 | 86 |
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| chematic_pipeline_v2_mmff94_strict | chematic_pipeline_v2_mmff94_strict_repair | 254 | 11 | 46 | 64 | 52 | 0 | 11 | 131 | 0 | 0 | 274 |
| chematic_pipeline_v2_mmff94_with_uff_fallback | chematic_pipeline_v2_mmff94_with_uff_fallback_repair | 254 | 11 | 46 | 64 | 52 | 0 | 13 | 229 | 0 | 0 | 501 |
...
**Measured result: 2,107 -> 0 missing stretch-bend instances** across the 265-molecule corpus (fresh `mmff94_term_coverage_audit.rs` re-run, same corpus/manifests as Priority 2's own measurement -- directly comparable, not a different scope). Full resolution: every instance the Priority 2 audit flagged as `dfsb_default_resolvable` now genuinely resolves in production, verified end-to-end rather than assumed to carry over from the diagnostic port.

### Missing-term sub-classification (fresh re-run, `mmff94_term_coverage_audit.rs`)

Per-term-instance classification across the 265-molecule corpus. `routing_bug_candidate` = this exact atom-type tuple has a table row at a *different* classification code than the one this molecule's context computed -- a candidate for an `angle_type_for`/`torsion_type_for`/`bond_type_for` classification bug, not necessarily a genuine table gap. `table_gap` = absent at *every* classification code chematic-ff's tables define (for StretchBend, this now means unresolved by the production Dfsb fallback too -- a genuine residual gap under RDKit's own complete algorithm, not just chematic's narrower one). `Oop` is listed explicitly even at 0 -- omitting a measured-zero term kind would be indistinguishable from "not measured", which it is not.
...
|---|---|---|---|---|---|
| chematic_pipeline_v2_mmff94_strict | chematic_pipeline_v2_mmff94_strict_stretch_bend_gated | 265 | 149 | 149 | 0 |
| chematic_pipeline_v2_mmff94_strict_stretch_bend_gated | chematic_pipeline_v2_mmff94_strict_complete_bonded_term_gated | 265 | 149 | 86 | 63 |
| chematic_pipeline_v2_mmff94_with_uff_fallback | chematic_pipeline_v2_mmff94_with_uff_fallback_stretch_bend_gated | 265 | 252 | 252 | 0 |
| chematic_pipeline_v2_mmff94_with_uff_fallback_stretch_bend_gated | chematic_pipeline_v2_mmff94_with_uff_fallback_complete_bonded_term_gated | 265 | 252 | 250 | 2 |

`chematic_pipeline_v2_mmff94_strict_complete_bonded_term_gated` newly-failing molecules (63): aspirin, atorvastatin_fragment, cinnamic_acid_E, cinnamic_acid_Z, testosterone, chembl_tier_b_0014, chembl_tier_b_0036, chembl_tier_b_0038, chembl_tier_b_0039, chembl_tier_b_0041, chembl_tier_b_0042, chembl_tier_b_0043, chembl_tier_b_0044, chembl_tier_b_0045, chembl_tier_b_0047, chembl_tier_b_0049, chembl_tier_b_0051, chembl_tier_b_0067, chembl_tier_b_0075, chembl_tier_b_0076, chembl_tier_b_0078, chembl_tier_b_0079, chembl_tier_b_0081, chembl_tier_b_0083, chembl_tier_b_0092, chembl_tier_b_0093, chembl_tier_b_0094, chembl_tier_b_0102, chembl_tier_b_0108, chembl_tier_b_0109, chembl_tier_b_0110, chembl_tier_b_0111, chembl_tier_b_0112, chembl_tier_b_0113, chembl_tier_b_0114, chembl_tier_b_0115, chembl_tier_b_0116, chembl_tier_b_0117, chembl_tier_b_0124, chembl_tier_b_0125, chembl_tier_b_0126, chembl_tier_b_0129, chembl_tier_b_0130, chembl_tier_b_0131, chembl_tier_b_0132, chembl_tier_b_0133, chembl_tier_b_0134, chembl_tier_b_0135, chembl_tier_b_0136, chembl_tier_b_0137, chembl_tier_b_0138, chembl_tier_b_0139, chembl_tier_b_0140, chembl_tier_b_0141, chembl_tier_b_0142, chembl_tier_b_0144, chembl_tier_b_0150, chembl_tier_b_0155, chembl_tier_b_0158, chembl_tier_b_0162, chembl_tier_b_0168, chembl_tier_b_0169, chembl_tier_b_0193

`chematic_pipeline_v2_mmff94_with_uff_fallback_complete_bonded_term_gated` newly-failing molecules (2): chembl_tier_b_0014, chembl_tier_b_0041

**On `mmff94_with_uff_fallback`'s success count varying slightly across runs**: this policy shares a wall-clock `total_timeout_ms` budget between the MMFF94 attempt and the UFF fallback -- `embed_seed` governs geometry/RNG determinism but NOT real-time scheduling, so a molecule whose MMFF94 attempt sits close to the timeout boundary can legitimately flip between timeout and success across runs depending on machine load, independent of any code change (see `newly_passing_explained_timeout_rescue` above for any case this specific run hit, each independently verified). This is a known, expected, low-magnitude source of ±1-2-molecule jitter in this arm's success count specifically -- not a hidden non-determinism bug, don't mistake a small delta from a previous run's number for a regression without checking `elapsed_ms` against the budget first.

**Scope of "adopted" this round**: the Dfsb periodic-row fallback itself (Priority 2B) IS now unconditional production behavior for every MMFF94 policy's energy/gradient calculation and coverage measurement -- not gated, not opt-in. What remains opt-in and `false` by default is the *strict-refusal* gate on top of that coverage (`gate_mmff94_stretch_bend`/`gate_mmff94_torsion_oop`) -- the legacy `mmff94_strict`/`mmff94_with_uff_fallback` arms reported elsewhere in this document still don't refuse on a missing stretch-bend/torsion/OOP term, they just now have real Dfsb-backed physics for the stretch-bend terms that used to silently contribute zero energy.
...
- chematic rows sha256: `c915a2941bdea429...`
...
| Bonded-term coverage gate, mmff94_strict -> mmff94_strict_stretch_bend_gated (new this round) | Real coverage gap surfaced, widening the gate is a real cost | 149 earlier-stage successes -> 149 under the later stage's gate (0 newly fail, 0.0% of earlier-stage successes) -- see the Bonded-term coverage gate section for the term-kind sub-classification and full molecule list |
| Bonded-term coverage gate, mmff94_strict_stretch_bend_gated -> mmff94_strict_complete_bonded_term_gated (new this round) | Real coverage gap surfaced, widening the gate is a real cost | 149 earlier-stage successes -> 86 under the later stage's gate (63 newly fail, 42.3% of earlier-stage successes) -- see the Bonded-term coverage gate section for the term-kind sub-classification and full molecule list |
| Bonded-term coverage gate, mmff94_with_uff_fallback -> mmff94_with_uff_fallback_stretch_bend_gated (new this round) | Real coverage gap surfaced, widening the gate is a real cost | 252 earlier-stage successes -> 252 under the later stage's gate (0 newly fail, 0.0% of earlier-stage successes) -- see the Bonded-term coverage gate section for the term-kind sub-classification and full molecule list |
| Bonded-term coverage gate, mmff94_with_uff_fallback_stretch_bend_gated -> mmff94_with_uff_fallback_complete_bonded_term_gated (new this round) | Real coverage gap surfaced, widening the gate is a real cost | 252 earlier-stage successes -> 250 under the later stage's gate (2 newly fail, 0.8% of earlier-stage successes) -- see the Bonded-term coverage gate section for the term-kind sub-classification and full molecule list |
| Force-field convergence rate | RDKit-favor, and an input to Priority 3 (Stage 1C) | chematic mmff94_with_uff_fallback 17.9% converged within 200 iterations, yet 252/265 of that arm's runs pass final validation regardless -- i.e. most successful outputs did NOT converge within 200 iterations and still passed geometry validation. Either `force_field_converged` is narrower than "produced a usable geometry" (an iteration-budget artifact, not necessarily a quality problem), or this is a real gap worth diagnosing -- Priority 3's MinimizationFailed root-causing (CatastrophicBondBlowup vs. ExcessiveResidualForce) is the next stage that should resolve which; corroborates open issues #185/#188 |
