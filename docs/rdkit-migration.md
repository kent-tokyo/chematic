...
Python bindings. Measured 2026-09-07 from the v1.0.9 release candidate (see the
[artifact record](../benchmarks/2026-09-07-wasm-size-v1.0.9.md)): chematic's WASM bundle is
