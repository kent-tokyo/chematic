...
Status: complete for chematic and RDKit; Open Babel was not installed and is
recorded as `not_installed`, not as a zero or a pass.

This is an operation-specific measurement, not a claim of universal
superiority. The run used chematic 1.0.1 from commit `bfaf1d52f9094702eda011451d6479ff0265d3cf`,
...
| Operation | chematic | RDKit | Relative result |
|---|---:|---:|---:|
| Import | 13.3 ms | 117.5 ms | chematic 8.8× faster |
| SMILES parse, 5,000 | 2.17 µs/mol | 48.65 µs/mol | chematic 22.3× faster |
| Canonical SMILES, 5,000 | 101.61 µs/mol | 24.97 µs/mol | chematic 4.1× slower |
| ECFP4, 5,000 diverse | 29.22 µs/mol | 88.77 µs/mol | chematic 3.0× faster |
| SDF read, 365 | 588.38 µs/mol | 99.15 µs/mol | chematic 5.9× slower |
| SDF write, 365 | 334.5 µs/mol | 39.15 µs/mol | chematic 8.5× slower |
